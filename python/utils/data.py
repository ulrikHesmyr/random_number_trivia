...
random_number_trivias = {
    ...
    27: [
        ...
        "27 is the number of letters in the Spanish alphabet (including ñ).",
    ...
    43: [
        ...
        "43 is the number of Beethoven's Piano Sonata No. 8 'Pathétique' in Opus.",
    ...
    68: [
        ...
        "68 is the number of the French department Nièvre.",
    ...
    70: [
        ...
        "70 is the number of the French department Haute-Saône.",
        "70 is the number of seats in the Knesset, the Israeli parliament."
    ],
    71: [
        "71 is the atomic number of lutetium.",
        "71 is a prime number.",
        "71 is the number of the French department Saône-et-Loire.",
    ...
    79: [
        ...
        "79 is the number of the French department Deux-Sèvres.",
    ...
    85: [
        ...
        "85 is the number of the French department Vendée.",
